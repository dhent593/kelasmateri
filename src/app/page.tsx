  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-[#070b13] text-slate-800 dark:text-slate-200">
      ...
      <footer className="mt-auto border-t border-slate-200 dark:border-slate-800/80 bg-slate-50 dark:bg-slate-950 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center gap-4 text-center text-slate-500 dark:text-slate-400 text-xs">
          ...
          <p className="leading-relaxed">&copy; {new Date().getFullYear()} kelasmateri. All rights reserved. Platform Tryout Mandiri & Simulasi CPNS 2026.</p>
        </div>
      </footer>
